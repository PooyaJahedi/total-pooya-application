...
To build the final jar and optimize the TotalPooyaApplication application for production, run:
...
Then navigate to [http://localhost:7077](http://localhost:7077) in your browser.
